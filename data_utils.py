...
def MAEDataLoader(img_dir, global_batch_size=4096,pos_enc=False,resize_shape = (256,256)):
    ...
    while m > 0:
        ...
        #input_batch: input image , gt_batch: ground truth image
        input_batch = []
        gt_batch = []
...
if __name__ == "__main__":
    ...
    for i,k in MAEDataLoader(img_dir=f"{os.getcwd()}/data",global_batch_size=128,pos_enc=True,resize_shape=(256,256)):
